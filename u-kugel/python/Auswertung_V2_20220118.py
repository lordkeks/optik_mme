...
'Bilder importieren'
A_40_B_1000_1 = importimage(os.path.join(basepath, '1_01.png'))
A_40_B_1000_2 = importimage(os.path.join(basepath, '1_02.png'))
A_40_B_2000_1 = importimage(os.path.join(basepath, '2_01.png'))
A_40_B_2000_2 = importimage(os.path.join(basepath, '2_02.png'))
A_40_B_3000_1 = importimage(os.path.join(basepath, '3_01.png'))
A_40_B_3000_2 = importimage(os.path.join(basepath, '3_02.png'))
A_40_B_4000_1 = importimage(os.path.join(basepath, '4_01.png'))
A_40_B_4000_2 = importimage(os.path.join(basepath, '4_02.png'))
A_40_B_5000_1 = importimage(os.path.join(basepath, '5_01.png'))
A_40_B_5000_2 = importimage(os.path.join(basepath, '5_02.png'))
A_40_B_6000_1 = importimage(os.path.join(basepath, '6_01.png'))
A_40_B_6000_2 = importimage(os.path.join(basepath, '6_02.png'))
A_40_B_7000_1 = importimage(os.path.join(basepath, '7_01.png'))
A_40_B_7000_2 = importimage(os.path.join(basepath, '7_02.png'))
A_40_B_8000_1 = importimage(os.path.join(basepath, '8_01.png'))
A_40_B_8000_2 = importimage(os.path.join(basepath, '8_02.png'))
A_40_B_9000_1 = importimage(os.path.join(basepath, '9_01.png'))
A_40_B_9000_2 = importimage(os.path.join(basepath, '9_02.png'))
A_40_B_10000_1 = importimage(os.path.join(basepath, '10_01.png'))
A_40_B_10000_2 = importimage(os.path.join(basepath, '10_02.png'))

basepath=r"C:\Users\Chris\Desktop\bildgebende_optische_systeme\optik_mme\u-kugel\neu\dunkel"

A_40_B_1000_ABG_1 = importimage(os.path.join(basepath, '1_01.png'))
A_40_B_1000_ABG_2 = importimage(os.path.join(basepath, '1_02.png'))
A_40_B_2000_ABG_1 = importimage(os.path.join(basepath, '2_01.png'))
A_40_B_2000_ABG_2 = importimage(os.path.join(basepath, '2_02.png'))
A_40_B_3000_ABG_1 = importimage(os.path.join(basepath, '3_01.png'))
A_40_B_3000_ABG_2 = importimage(os.path.join(basepath, '3_02.png'))
A_40_B_4000_ABG_1 = importimage(os.path.join(basepath, '4_01.png'))
A_40_B_4000_ABG_2 = importimage(os.path.join(basepath, '4_02.png'))
A_40_B_5000_ABG_1 = importimage(os.path.join(basepath, '5_01.png'))
A_40_B_5000_ABG_2 = importimage(os.path.join(basepath, '5_02.png'))
A_40_B_6000_ABG_1 = importimage(os.path.join(basepath, '6_01.png'))
A_40_B_6000_ABG_2 = importimage(os.path.join(basepath, '6_02.png'))
A_40_B_7000_ABG_1 = importimage(os.path.join(basepath, '7_01.png'))
A_40_B_7000_ABG_2 = importimage(os.path.join(basepath, '7_02.png'))
A_40_B_8000_ABG_1 = importimage(os.path.join(basepath, '8_01.png'))
A_40_B_8000_ABG_2 = importimage(os.path.join(basepath, '8_02.png'))
A_40_B_9000_ABG_1 = importimage(os.path.join(basepath, '9_01.png'))
A_40_B_9000_ABG_2 = importimage(os.path.join(basepath, '9_02.png'))
A_40_B_10000_ABG_1 = importimage(os.path.join(basepath, '10_01.png'))
A_40_B_10000_ABG_2 = importimage(os.path.join(basepath, '10_02.png'))
