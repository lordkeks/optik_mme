...
y_dark_t4500 = getdarkorwhiteimg('Test_Aufgabe_3/Dunkel/')
y_dark_t1000 = getdarkorwhiteimg('Test_Aufgabe_5_neu/Dunkelbild/B_5000/')
y_50 = getdarkorwhiteimg('Test_Aufgabe_5_neu/Optik/Alt/')

'Dunkelbild interpolieren'
y_dark_texp = interpolat_dark_image(y_dark_t4500, y_dark_t1000, 4500, 1000, 300)
